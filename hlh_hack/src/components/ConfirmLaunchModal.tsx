            ...
            <div className="space-y-4 mb-6">
              <div className="rounded-[12px] border border-[color:var(--color-border)] bg-[color:var(--color-input-background)] p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-white">${totalCost.toFixed(2)}</div>
                  </div>
                </div>
              </div>
                  ...
                  {selectedAssets.map((asset) => (
                    <div key={asset.symbol} className="flex items-center justify-between text-sm">
                      ...
                      <div className="text-right">
                        <div className="text-white">{asset.allocationPct}%</div>
                        <div className="text-[color:var(--color-muted-foreground)] text-xs">
                          ${asset.hypeAmount}
                        </div>
                      </div>
                    </div>
              ...
              <div className="rounded-[12px] border border-[color:var(--color-border)] bg-[color:var(--color-input-background)] p-4">
                ...
                <div className="flex justify-between items-center mt-2 pt-2 border-t border-[color:var(--color-border)]">
                  ...
                  <span className="text-white font-medium">${(totalCost + feeAmount).toFixed(2)}</span>
                </div>
              </div>
            </div>
          ...
          <>
            ...
            <div className="text-center">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleClose}
                  className="flex-1 rounded-[12px] bg-[color:var(--color-primary)] px-4 py-3 text-[color:var(--color-primary-foreground)] font-medium"
                >
                  Done
                </button>
              </div>
